...
window.quizList.push(
    {
        name: '7 Wonders of the New World',
        id: '7-wonders-new',
        order: 'strict',
        questions:
        [
...
window.quizList.push(
    {
        ...
        "questions": [
            {
                "question": "In which city is the headquarters of Intel and AMD, located?",
                "answer": { "label": "Santa Clara, USA", "lat": 37.3541, "lng": -121.9552 },
                "context": "Santa Clara, part of Silicon Valley, houses Intel’s and AMD's corporate headquarters where it leads in semiconductor manufacturing and innovation."
            },
            {
                "question": "Which city in South Korea is renowned for being the center of Samsung Electronics, a major player in the semiconductor industry?",
                "answer": { "label": "Suwon, South Korea", "lat": 37.2636, "lng": 127.0286 },
                "context": "Suwon is known globally for being the headquarters of Samsung Electronics, a leader in semiconductor technology."
            },
            {
                "question": "Which German city is home to one of Europe’s largest semiconductor manufacturers, Infineon Technologies?",
                "answer": { "label": "Munich, Germany", "lat": 48.1351, "lng": 11.5820 },
                "context": "Munich hosts the headquarters of Infineon Technologies, a global leader in semiconductor solutions for power systems."
            },
            {
                "question": "What is the name of the city known as the home of ASML, the world's largest supplier of photolithography systems for semiconductor industry?",
                "answer": { "label": "Veldhoven, Netherlands", "lat": 51.4188, "lng": 5.4020 },
                "context": "ASML, based in Veldhoven, is pivotal to the semiconductor industry and supplies advanced machinery for chip manufacturers worldwide."
            },
            {
                "question": "Where are the headquarters of Texas Instruments, one of the major American semiconductor companies, located?",
                "answer": { "label": "Dallas, USA", "lat": 32.7767, "lng": -96.7970 },
                "context": "Texas Instruments, headquartered in Dallas, is crucial in the creation of semiconductors used across various technologies."
            },
            {
                "question": "Which city is the home of TSMC, the world's largest dedicated independent semiconductor foundry?",
                "answer": { "label": "Hsinchu, Taiwan", "lat": 24.8138, "lng": 120.9675 },
                "context": "Hsinchu Science Park houses TSMC, ensuring its position at the forefront of semiconductor manufacturing globally."
            },
            {
                "question": "Where in China is the main operational base of SMIC, the largest semiconductor foundry on the mainland?",
                "answer": { "label": "Shanghai, China", "lat": 31.2304, "lng": 121.4737 },
                "context": "Shanghai hosts SMIC's primary operations, marking it as a critical center for semiconductor manufacturing in China."
            }            
        ]
    });
window.quizList.push(
...
window.quizList.push(
    {
        "name": "Oil Industry - Basic",
        "id": "oil-industry-basic",
        "order": "strict",
        "questions": [
            {
...
window.quizList.push(
    {
        "name": "Atomic power - the good, the bad and the ugly",
        "id": "atomic-power",
        "order": "strict",
        "questions": [
            {
                "question": "Location of the world's first artificial nuclear reactor (CP-1), was constructed under the stands of which university's football stadium?",
                "answer": { "label": "University of Chicago, USA", "lat": 41.7886, "lng": -87.5987 },
                "context": "Constructed as part of the Manhattan Project, Chicago Pile-1 achieved the first controlled nuclear chain reaction on December 2, 1942, under the stands of Stagg Field at the University of Chicago."
            },
            {
                "question": "Where is the world's largest uranium mine by production located?",
                "answer": { "label": "Cigar Lake Project, Canada", "lat": 58.0801, "lng": -105.1748 },
                "context": "Cigar Lake in Saskatchewan, Canada, accounts for 14 percent of global production."
            },
            {
                "question": "The world's first commercial nuclear power station was built in which town?",
                "answer": { "label": "Calder Hall, Sellafield, UK", "lat": 54.4226, "lng": -3.5034 },
                "context": "Calder Hall at Sellafield in the UK was the world's first nuclear power station to deliver electricity in a commercial capacity, opening on October 17, 1956."
            },
            {
                "question": "Location of the first commercial nuclear power plant in the US?",
                "answer": { "label": "Shippingport, Pennsylvania, USA", "lat": 40.6223, "lng": -80.4273 },
                "context": "On May 26, 1958, the first commercial nuclear power plant in the United States, Shippingport Atomic Power Station, was opened by President Dwight D. Eisenhower as part of his Atoms for Peace program."
            },
            {
                "question": "This Nuclear Power Plant is unique as it was fully constructed but never went into operation. It's located in a country that has no operational nuclear power plants.",
                "answer": { "label": "Zwentendorf an der Donau, Austria", "lat": 48.3492, "lng": 15.8997 },
                "context": "The Zwentendorf Nuclear Power Plant in Austria was completed in the late 1970s, but a referendum prevented it from becoming operational, marking a significant moment in Austrian energy policy."
            },            
            {
                "question": "Where is the ITER, the world's largest experimental nuclear fusion reactor, being constructed?",
                "answer": { "label": "Cadarache, France", "lat": 43.7033, "lng": 5.7522 },
                "context": "The ITER project aims to demonstrate the feasibility of nuclear fusion as a large-scale and carbon-free source of energy."
            },
            {
                "question": "In which city did the largest nuclear disaster in history occur in 1986?",
                "answer": { "label": "Chernobyl, Ukraine", "lat": 51.2769, "lng": 30.2213 },
                "context": "The Chernobyl disaster is considered the worst nuclear power plant accident in history, both in terms of cost and casualties."
            },
            {
                "question": "Location of a major nuclear disaster in 2011 following a tsunami.",
                "answer": { "label": "Fukushima, Japan", "lat": 37.7608, "lng": 140.4747 },
                "context": "The Fukushima disaster prompted widespread discussion on the safety of nuclear energy, significantly impacting global energy policies."
            },
            {
                "question": "Location of the most serious accident in U.S. commercial nuclear power plant history?",
                "answer": { "label": "Three Mile Island, Pennsylvania, USA", "lat": 40.1538, "lng": -76.7278 },
                "context": "The Three Mile Island accident, which took place on March 28, 1979, was the most serious accident in U.S. commercial nuclear power plant history, leading to widespread changes in nuclear safety regulations."
            },            
            {
                "question": "The Trinity test, the first detonation of a nuclear weapon as part of the Manhattan Project, took place at which location?",
                "answer": { "label": "Trinity Site, New Mexico, USA", "lat": 33.6773, "lng": -106.4756 },
                "context": "The Trinity test, conducted on July 16, 1945, at the White Sands Proving Ground in New Mexico, marked the world's first nuclear explosion and was a pivotal step in the development of atomic weapons."
            },
            {
                "question": "The Polygon, a primary nuclear testing site during the Cold War, is located in the former Soviet Republic? Where exactly?",
                "answer": { "label": "Semipalatinsk Test Site, Kazakhstan", "lat": 50.4000, "lng": 77.8000 },
                "context": "The Semipalatinsk Test Site (also known as 'The Polygon') was the primary testing site for the Soviet Union, with 456 nuclear tests conducted from 1949 to 1989, leaving significant environmental and health impacts."
            },
            {
                "question": "The first city targeted by an atomic bomb during World War II.",
                "answer": { "label": "Hiroshima, Japan", "lat": 34.3853, "lng": 132.4553 },
                "context": "On August 6, 1945, the first atomic bomb used in warfare was dropped on Hiroshima by the United States, resulting in massive destruction and loss of life."
            },
            {
                "question": "The second city to experience an atomic bomb attack during World War II.",
                "answer": { "label": "Nagasaki, Japan", "lat": 32.7503, "lng": 129.8777 },
                "context": "Following the bombing of Hiroshima, the United States dropped a second atomic bomb on Nagasaki on August 9, 1945, leading to Japan's eventual surrender and the end of World War II."
            }            
        ]
    });
window.quizList.push(
